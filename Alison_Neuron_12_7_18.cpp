#include <Alison_Neuron_12_7_18.h>
#include <math.h>
...
{
    return new Alison_Neuron_12_7_18();
}
...
Alison_Neuron_12_7_18::Alison_Neuron_12_7_18(void) : DefaultGUIModel("Alison_Neuron_12_7_18", ::vars, ::num_vars) {
    setWhatsThis(
    "<p><b>Alison_Neuron_12_7_18:</b><br>This module simulates a neuron with an A Current.</p>");
...
Alison_Neuron_12_7_18::~Alison_Neuron_12_7_18(void) {}

void Alison_Neuron_12_7_18::execute(void) {
...
void Alison_Neuron_12_7_18::update(DefaultGUIModel::update_flags_t flag) {
    switch (flag) {
        case INIT:
...
void Alison_Neuron_12_7_18::initParameters() {
    V0 = -55.038; // mV
    G_Na_max = 0.24;
    G_K_max = 0.011;
    G_L = 0.0018;
...
void Alison_Neuron_12_7_18::solve(double dt, double *y) {
    double dydt[7];
    derivs(y, dydt);
...
void Alison_Neuron_12_7_18::derivs(double *y, double *dydt) {
